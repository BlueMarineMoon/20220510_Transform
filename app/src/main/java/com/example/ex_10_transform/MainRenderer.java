...
public class MainRenderer implements GLSurfaceView.Renderer {
    ...
    /*String arr1 [] = {"andy.obj", "andy.png"};
    String arr2 [] = {"coffee_cup.obj", "Base_color.png"};
    ...
    MainRenderer(Context context, RenderCallback callback){
        ...
        //mObj = new ObjRenderer(context, "coffee_cup.obj", "Base_color.png");
        //mObj = new ObjRenderer(context, arr1[count], arr2[count]);
    }
