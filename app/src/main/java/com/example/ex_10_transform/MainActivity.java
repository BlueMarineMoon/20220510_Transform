            ...
            public void preRender() {
                ...
                /*View.OnClickListener onClickListener = new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        switch (view.getId()) {
                            case R.id.andybtn :
                                Log.d("안드버튼클릭","안드로이드버튼클릭했음1111");
                                //mRenderer.count(1);
                                break;
                            case R.id.coffeebtn :
                                Log.d("커피버튼클릭","커피버튼클릭했음22222");
                                //mRenderer.count(2);
                                break;
                        }
                    }
                };
                findViewById(R.id.andybtn).setOnClickListener(onClickListener);
                findViewById(R.id.coffeebtn).setOnClickListener(onClickListener);*/
